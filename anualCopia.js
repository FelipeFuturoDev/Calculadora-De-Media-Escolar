var numero_notas, um_, dois_, tres_, quatro_, cinco_, seis_, sete_, oito_, soma_1, soma_2, soma_geral, media;
 ...
 function somar(){
   ...
   soma_1 = parseFloat(um_) + parseFloat(quatro_) + parseFloat(tres_) + parseFloat(seis_);


   soma_2 = parseFloat(dois_) + parseFloat(sete_) + parseFloat(cinco_) + parseFloat(oito_);
   
   
   soma_geral = parseFloat(soma_1) + parseFloat(soma_2);

   numero_notas = 8;     
   media = parseFloat(soma_geral) / parseFloat(numero_notas);
